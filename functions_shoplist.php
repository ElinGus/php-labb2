...
// Sparar ett listnamn 
function saveListName($conn,$id){
  
    $name = escapeInsert($conn,$_POST['title']);
...
function saveProduct($conn,$productName){
    ...
    $prodName = escapeInsert($conn,$_POST['prodName']);
...
function saveProdshoplist($conn,$prodId,$listId){
...
function createShoplist($conn){
    $productName = escapeInsert($conn,$_POST['prodName']);
    $listId = escapeInsert($conn,$_POST['listid']);      
    $prodId = saveProduct($conn,$productName);
    
  // Spara produkten tillsammans med listan (mellantabellen)
  saveProdshoplist($conn,$prodId,$listId);        
}
